...
( function() {
	...
	CKEDITOR.plugins.tabletoolsbutton = {
		requires: 'table,dialog,menubutton',
		icons: 'tabletools',
		init: function( editor ) {
			...
			editor.ui.add( 'TableTools', CKEDITOR.UI_MENUBUTTON, {
				label: lang.toolbar,
				modes: { wysiwyg: 1 },
				toolbar: 'insert,30',
				onMenu: function() {
					...
					var cell = path.contains( { 'td': 1, 'th': 1 }, 1 );
					var state = cell && !cell.isReadOnly() ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED;
					return {
						tablecell: state,
						tablerow: state,
						tablecolumn: state,
	...
	CKEDITOR.plugins.add( 'tabletoolsbutton', CKEDITOR.plugins.tabletoolsbutton );
} )();
